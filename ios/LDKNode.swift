...
public struct FfiConverterTypeBuildError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> BuildError {
        ...
        case 6: return try .ReadFailed(
                message: FfiConverterString.read(from: &buf)
            )

        case 7: return try .WriteFailed(
                message: FfiConverterString.read(from: &buf)
            )

        case 8: return try .StoragePathAccessFailed(
                message: FfiConverterString.read(from: &buf)
            )

        case 9: return try .KvStoreSetupFailed(
                message: FfiConverterString.read(from: &buf)
            )

        case 10: return try .WalletSetupFailed(
                message: FfiConverterString.read(from: &buf)
            )

        case 11: return try .LoggerSetupFailed(
                message: FfiConverterString.read(from: &buf)
            )
...
public struct FfiConverterTypeEvent: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Event {
        ...
        case 4: return try .channelPending(
                channelId: FfiConverterTypeChannelId.read(from: &buf),
                userChannelId: FfiConverterTypeUserChannelId.read(from: &buf),
...
public struct FfiConverterTypeNodeError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> NodeError {
        ...
        case 6: return try .PaymentSendingFailed(
                message: FfiConverterString.read(from: &buf)
            )

        case 7: return try .ProbeSendingFailed(
                message: FfiConverterString.read(from: &buf)
            )

        case 8: return try .ChannelCreationFailed(
                message: FfiConverterString.read(from: &buf)
            )

        case 9: return try .ChannelClosingFailed(
                message: FfiConverterString.read(from: &buf)
            )

        case 10: return try .ChannelConfigUpdateFailed(
                message: FfiConverterString.read(from: &buf)
            )

        case 11: return try .PersistenceFailed(
                message: FfiConverterString.read(from: &buf)
            )

        case 12: return try .FeerateEstimationUpdateFailed(
                message: FfiConverterString.read(from: &buf)
            )

        case 13: return try .WalletOperationFailed(
                message: FfiConverterString.read(from: &buf)
            )

        case 14: return try .OnchainTxSigningFailed(
                message: FfiConverterString.read(from: &buf)
            )

        case 15: return try .MessageSigningFailed(
                message: FfiConverterString.read(from: &buf)
            )

        case 16: return try .TxSyncFailed(
                message: FfiConverterString.read(from: &buf)
            )

        case 17: return try .GossipUpdateFailed(
                message: FfiConverterString.read(from: &buf)
            )

        case 18: return try .InvalidAddress(
                message: FfiConverterString.read(from: &buf)
            )

        case 19: return try .InvalidSocketAddress(
                message: FfiConverterString.read(from: &buf)
            )

        case 20: return try .InvalidPublicKey(
                message: FfiConverterString.read(from: &buf)
            )

        case 21: return try .InvalidSecretKey(
                message: FfiConverterString.read(from: &buf)
            )

        case 22: return try .InvalidPaymentHash(
                message: FfiConverterString.read(from: &buf)
            )

        case 23: return try .InvalidPaymentPreimage(
                message: FfiConverterString.read(from: &buf)
            )

        case 24: return try .InvalidPaymentSecret(
                message: FfiConverterString.read(from: &buf)
            )

        case 25: return try .InvalidAmount(
                message: FfiConverterString.read(from: &buf)
            )

        case 26: return try .InvalidInvoice(
                message: FfiConverterString.read(from: &buf)
            )

        case 27: return try .InvalidChannelId(
                message: FfiConverterString.read(from: &buf)
            )

        case 28: return try .InvalidNetwork(
                message: FfiConverterString.read(from: &buf)
            )

        case 29: return try .DuplicatePayment(
                message: FfiConverterString.read(from: &buf)
            )

        case 30: return try .InsufficientFunds(
                message: FfiConverterString.read(from: &buf)
            )

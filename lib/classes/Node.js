...
export class Node extends NativeLoader {
     ...
     * @returns {Promise<boolean>}
     */
    async receiveViaJitChannel(amountMsat, description, expirySecs) {
        return await this._ldk.receiveVariableAmountPayment(this.id, description, expirySecs);
    }
    /**
    ...
    async updateChannelConfig(channelId, counterpartyNodeId, channelConfig) {
        return await this._ldk.updateChannelConfig(this.id, channelId.channelIdHex, counterpartyNodeId.keyHex, channelConfig.id);
    }
    /**
     ...
     * @returns {Promise<boolean>}
     */
    async sendPaymentProbes(invoice) {
     ...
     * @returns {Promise<boolean>}
     */
    async sendPaymentProbesUsingAmount(invoice, amountMsat) {
        return await this._ldk.sendPaymentProbesUsingAmount(this.id, invoice, amountMsat);
    }
    /**
     ...
     * @returns {Promise<boolean>}
     */
    async sendSpontaneousPaymentProbes(amountMsat, nodeId) {
        return await this._ldk.sendSpontaneousPaymentProbes(this.id, amountMsat, nodeId.keyHex);
    }
}
